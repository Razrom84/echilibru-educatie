...
- **Săptămâna:** ritualul o dată sus; pe zilele din pilot: iconița personajului, 4 piloni, chip Surpriză. S1–S20 au chrome L–D. S21+ rămân fără chrome playful.
...
3. S# **Săptămâna 1**: Căsuță, `Casa și curtea.`, Luni fizic `Pași în curte`. S# **Săptămâna 2**: Găletuță, `Apa în casă.`.
